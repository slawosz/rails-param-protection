...
This gem provides two methods for Rails Controller: params_accesible and params protected.
...
When both declaration is present in controller or in controller inheritance hierarchy, then RailsParamProtection::ParamsFilteringDefinitionMismatch will be thrown.
